...
ActiveRecord::Schema.define(version: 2019_07_01_184259) do
  ...
  create_table "books_authors", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "book_id"
    t.bigint "author_id"
